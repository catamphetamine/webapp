...
дописать в доку про мониторинг примеры замеров

посмотреть, почему прелоад занимает много на сервере

сделать прекешированный рендер html dummy, если рендер dummy занимает много времени

Мб сделать опцию передачи html шаблона строкой
