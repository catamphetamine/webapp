...
сломались ошибки вида "пользователь уже существует", т.к. возвращается текст ошибки в html в react-isomorphic-render : починить их как-то, мб передавать в заголовках
...
при смене почты - менять её также в user_authentication
