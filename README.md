...
сейчас если есть Form.Actions в Modal - не закрывает по клику вовне.
можно (мб) сделать так, чтобы закрывало, если форма "не тронута"


вместо buttons у всего modal при шагах и формах делать нормальные buttons
