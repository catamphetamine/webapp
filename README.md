...
растягивать background_pattern и banner на норм разрешение файла




из конфига брать цветовую схему и название сайта



проставлять 3 picture как id, и добавлять их в poster.data





для малых экранов не показывать имя пользователя, а просто аватар, а вместо имени будут выводиться: иконка сообщений, иконка уведомлений.


сделать отдельное поле "description", а для location выводить значок, как на карте, и можно даже отправлять ссылкой на Яндекс.Карты при нажатии.


кастомные иконки ссылок (autodetect) для твитора, инстаграма, vk, фейсбука.
...
Не создавать пдресное имя при регистрации
...
стилизовать personal info для малых размеров экрана

на неосновных разделах профиля, помеченных особым классом (.poster-profile--wide-content) - левую колонку убирать, писать имя и адрес вверху, справа от аватара, и ссылкой на профиль делать имя.
