...
user:online:${user_id} = Date

получать из редиса время последней активности
если минута прошла - писать в базу
писать в редис




из базы вычислять, когда был пользователь на сайте
