...
хранить историю username'ов, и по ней искать, когда find_user()

убирать из истории username'ов, когда у кто-то занимает этот username



(то же самое можно сделать для смены почты и пароля)
