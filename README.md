...
вместе с картинкой слать также type, по которому будет определяться output_folder

для type сделать путь output_folder и набор опций

сделать ограничение на размер картинки - мегабайтов 10 (проверять на клиенте + ошибку такую засекать для web 1.0).

если размер картинки меньше 1.1 * размер ресайза, то не делать ресайз, и оставлять оринигал

сделать загрузку картинки web 1.0 (+ случай с ошибкой)
