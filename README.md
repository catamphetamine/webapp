...
редактирование профиля сделать как в твиттере

сделать загрузку аватара (если зашёл на свой профиль)

сделать ограничение на размер аватара - мегабайтов 10 (проверять на клиенте).
...
под аватаром пользователя - кнопку "Отправить сообщение"




 
имя пользователя - dropdown (без стрелки) с пунктами "Профиль", "Настройки", "Уведомления", "Выйти"
