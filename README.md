...
border мб не в px, а в em

валидацию полей при регистрации пользователя

валидацию полей при входе пользователя
...
фокус на форме при открытии окошка (+ при нажатии на "или ...")
