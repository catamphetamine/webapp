...
анимацию диалогового окна можно сделать

мб фон как-то стилизовать (а мб и не стилизовать)


валидировать все поля при нажатии "войти" или "зарегаться"




сообщения об ошибках формы - делать рядом с соответствующими полями формы



проверить дизайн формы на всех размерах экрана
