...
{
	const get_data_dependency = (component = {}, method_name) =>
	{
		return component.WrappedComponent ?
			get_data_dependency(component.WrappedComponent, method_name) :
	...
	return components
		.filter(component => get_data_dependency(component, method_name)) // only look at ones with a static preload()
		.map(component => get_data_dependency(component, method_name))    // pull out fetch data methods
